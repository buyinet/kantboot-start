 ...
 * 商品采购单DAO
 */
public interface BusGoodsProcureOrderRepository extends JpaRepository<BusGoodsProcureOrder, Long> {

    @Query("""
            select t from BusGoodsProcureOrder t
            where 1=1
            ...
            order by t.id desc
    """)
    Page<BusGoodsProcureOrder> getBodyData(
