...
@Getter
@Setter
@Table(name = "bus_goods_procure_return_order")
@Accessors(chain = true)
@EntityListeners(AuditingEntityListener.class)
@DynamicUpdate
@DynamicInsert
public class BusGoodsProcureReturnOrder  implements java.io.Serializable
{
     ...
     * 状态编码：已退货
     */
    public final static String STATUS_CODE_RETURNED = "returned";
    ...
    @OneToMany
    @JoinColumn(name = "procure_return_order_id",referencedColumnName = "id",insertable = false,updatable = false)
    private List<BusGoodsProcureReturnOrderIn> inList;
