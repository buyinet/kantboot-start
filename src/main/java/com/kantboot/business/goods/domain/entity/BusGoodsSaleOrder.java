...
@Getter
@Setter
@Table(name = "bus_goods_sale_order")
@Accessors(chain = true)
@EntityListeners(AuditingEntityListener.class)
@DynamicUpdate
@DynamicInsert
public class BusGoodsSaleOrder implements Serializable {
     ...
     * 状态编码：已销售
     */
    public final static String STATUS_CODE_SOLD = "sold";
    ...
    private List<BusGoodsSaleOrderIn> inList;
