...
@RestController
@RequestMapping("/business-goods-web/admin/goodsProcureOrder")
public class BusGoodsProcureOrderControllerOfAdmin {

    @Resource
    private IBusGoodsProcureOrderService service;
    ...
    public RestResult save(
            @RequestBody BusGoodsProcureOrder entity
            ) {
