...
public class FunctionalFileServiceImpl implements IFunctionalFileService {
     ...
     */
    @SneakyThrows
    private FunctionalFile frontUploadFile(MultipartFile file, String fileUploadPath, String groupCode) {
        Long userId =  null;
    ...
    @Override
    public FunctionalFile upload(MultipartFile file, String groupCode) {
